...
transcriptome <- read.csv("~/Desktop/Omics-Project-master/filter-data/transcriptome.csv")
all_samples <- read.csv("~/Desktop/Omics-Project-master/filter-data/all_samples.csv")
```
...
tflip_PCA <- PCA(transcriptome_flip)
```
...
```{r}
Trascrip <- data.frame(transcriptome_flip, location = all_samples$lesional)

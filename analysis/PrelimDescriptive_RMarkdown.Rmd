...
Create a dataset of unique participants and describe their characteristics
...
gender %>% kable(caption = "Gender (AD Group)") %>% kable_styling(bootstrap_options = "striped", full_width = F)
...
age %>% kable(caption = "Age (AD Group)") %>% kable_styling(bootstrap_options = "striped", full_width = F)
...
A substantial portion of the AD group report allergies to substances, including pollen (48.2%), food (37.8%), and animals (33.6%)
